...
for t in range(30):
    ...
    performance_history1.append([Qg, Qb, total_time])
...
performance_record1 = pd.DataFrame({'G': performance_history1[:, 0], 'D': performance_history1[:, 1], 'Running Time': performance_history1[:, 2]})
